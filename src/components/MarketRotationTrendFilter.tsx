        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1 text-xs bg-background border border-border rounded-md"
            >
              {sectors.map((sector) => (
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1 bg-muted rounded-lg p-1">
              ...
              <Button
                ...
                className="px-3 py-1 h-8 text-xs flex items-center gap-1"
              >
          ...
          {/* <div className="flex items-center gap-2 flex-1 max-w-xs">
            ...
            <input
              ...
              className="flex-1 px-3 py-1 text-xs bg-background border border-border rounded-md"
            />
          </div> */}
        </div>
      </Card>
