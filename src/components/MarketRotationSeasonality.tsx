            ...
            {months.map((month, index) => {
              ...
              return (
                <div key={month} className="text-center">
                  ...
                  <div 
                    className="h-16 rounded-md flex items-center justify-center text-sm font-medium transition-colors"
                    style={{ 
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-7 pr-3 py-1.5 text-xs bg-background border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 w-32"
                />
              </div>
