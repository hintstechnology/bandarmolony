    ...
    try {
      ...
      if (finalLogId) {
        await SchedulerLogService.updateLog(finalLogId, {
          ...
          current_processing: `Starting Broker Transaction Stock F/D RG/TN/NG calculation for ${targetDate}...`
        });
      }
      ...
      return {
        success: false,
        message: `Failed to generate broker transaction stock F/D RG/TN/NG data: ${errorMessage}`
      };
    }
  }
