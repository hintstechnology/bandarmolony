...
const BATCH_SIZE_PHASE_3 = 4;   // Phase 3: 4
const MAX_CONCURRENT_REQUESTS_PHASE_3 = 2; // Phase 3: 2 concurrent
const BATCH_SIZE_PHASE_4 = 4;   // Phase 4: 4
const MAX_CONCURRENT_REQUESTS_PHASE_4 = 2; // Phase 4: 2 concurrent
const BATCH_SIZE_PHASE_5 = 4;   // Phase 5: 4
const MAX_CONCURRENT_REQUESTS_PHASE_5 = 2; // Phase 5: 2 concurrent
const BATCH_SIZE_PHASE_6 = 4;   // Phase 6: 4
const MAX_CONCURRENT_REQUESTS_PHASE_6 = 2; // Phase 6: 2 concurrent
const BATCH_SIZE_PHASE_7 = 4;   // Phase 7: 4
const MAX_CONCURRENT_REQUESTS_PHASE_7 = 2; // Phase 7: 2 concurrent
const BATCH_SIZE_PHASE_8 = 4;   // Phase 8: 4
const MAX_CONCURRENT_REQUESTS_PHASE_8 = 2; // Phase 8: 2 concurrent
