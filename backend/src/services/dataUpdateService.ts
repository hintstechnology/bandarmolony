...
const BATCH_SIZE_PHASE_3 = 2;   // Phase 3: 2
const MAX_CONCURRENT_REQUESTS_PHASE_3 = 1; // Phase 3: 1 concurrent
const BATCH_SIZE_PHASE_4 = 2;   // Phase 4: 2
const MAX_CONCURRENT_REQUESTS_PHASE_4 = 1; // Phase 4: 1 concurrent
const BATCH_SIZE_PHASE_5 = 2;   // Phase 5: 2
const MAX_CONCURRENT_REQUESTS_PHASE_5 = 1; // Phase 5: 1 concurrent
const BATCH_SIZE_PHASE_6 = 2;   // Phase 6: 2
const MAX_CONCURRENT_REQUESTS_PHASE_6 = 1; // Phase 6: 1 concurrent
const BATCH_SIZE_PHASE_7 = 2;   // Phase 7: 2
const MAX_CONCURRENT_REQUESTS_PHASE_7 = 1; // Phase 7: 1 concurrent
const BATCH_SIZE_PHASE_8 = 2;   // Phase 8: 2
const MAX_CONCURRENT_REQUESTS_PHASE_8 = 1; // Phase 8: 1 concurrent
