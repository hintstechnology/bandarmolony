...
import { loadStockList } from '../../data/stockList';
  ...
  useEffect(() => {
    const loadStocks = async () => {
      ...
      try {
        ...
        const [_, sectorResult] = await Promise.all([
        ...
        // Get stocks from stockList.ts (already loaded by loadStockList)
        const { getStockList } = await import('../../data/stockList');
        stocks = getStockList();
