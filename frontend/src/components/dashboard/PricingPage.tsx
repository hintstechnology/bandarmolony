        ...
        <section className="grid gap-6 md:grid-cols-3">
          {pricingPlans.map((plan, index) => (
            <motion.article
              ...
              className={`relative flex h-full flex-col rounded-3xl border border-white/10 bg-background/80 p-8 shadow-xl backdrop-blur transition-all duration-300 hover:-translate-y-2 hover:shadow-primary/20 dark:border-white/5 ${plan.popular
                  ? 'ring-2 ring-primary'
                  : ''
                }`}
            >
              ...
              <Button
                className={`mt-auto w-full py-6 text-lg font-semibold transition-all duration-300 ${plan.popular
