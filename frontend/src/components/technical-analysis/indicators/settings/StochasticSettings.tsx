...
export interface StochasticSettingsProps {
  editedIndicator: any;
  setEditedIndicator: (indicator: any) => void;
}

export function StochasticSettings({ editedIndicator, setEditedIndicator }: StochasticSettingsProps) {
  return (
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-medium mb-2">%K Period</label>
        <input
          type="number"
      ...
      <div>
        <label className="block text-sm font-medium mb-2">%K Color</label>
