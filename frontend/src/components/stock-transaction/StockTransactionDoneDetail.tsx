...
import { Calendar, Grid3X3, Loader2, Settings, Search } from 'lucide-react';
...
import { StockTransactionDoneDetailCustomizeFields } from './StockTransactionDoneDetailCustomizeFields';

export interface DoneDetailData {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-row relative">
        ...
        <StockTransactionDoneDetailCustomizeFields
          isPivotBuilderOpen={isPivotBuilderOpen}
          setIsPivotBuilderOpen={setIsPivotBuilderOpen}
          availableFields={availableFields}
          tempPivotConfig={tempPivotConfig}
          setTempPivotConfig={setTempPivotConfig}
          draggedField={draggedField}
          setDraggedField={setDraggedField}
          draggedFromSource={draggedFromSource}
          setDraggedFromSource={setDraggedFromSource}
          draggedIndex={draggedIndex}
          setDraggedIndex={setDraggedIndex}
          touchDragState={touchDragState}
          setTouchDragState={setTouchDragState}
          dropZoneHighlight={dropZoneHighlight}
          handleDropTemp={handleDropTemp}
          tempFilterSearchTerms={tempFilterSearchTerms}
          setTempFilterSearchTerms={setTempFilterSearchTerms}
          tempOpenFilterDropdowns={tempOpenFilterDropdowns}
          setTempOpenFilterDropdowns={setTempOpenFilterDropdowns}
          doneDetailData={doneDetailData}
