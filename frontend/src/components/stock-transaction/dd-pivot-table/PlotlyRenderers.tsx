...
function makeRenderer(
    PlotlyComponent: React.ComponentType<any>,
    traceOptions = {},
    layoutOptions = {},
    transpose = false
) {
    class Renderer extends React.PureComponent<any> {
        ...
        render() {
            ...
            if ((traceOptions as any).type === 'pie') {
    ...
    return Renderer as any as React.ComponentType<any>;
}

function makeScatterRenderer(PlotlyComponent: React.ComponentType<any>) {
    class Renderer extends React.PureComponent<any> {
        static defaultProps = Object.assign({}, PivotData.defaultProps, {
            plotlyOptions: {},
            plotlyConfig: {},
...
export default function createPlotlyRenderers(PlotlyComponent: React.ComponentType<any>) {
    return {
